...
export const PROFILE: Profile[] = [
  {
    ...
    social: [
      {
        url: "https://www.facebook.com/daniel.fiakpo/",
        icon: FaFacebook,
        color: "#1877f2",
      },
      {
        url: "https://www.instagram.com/officialdannymusique/",
        icon: FaInstagram,
        color: " #bc2a8d",
      },
      {
        url: "https://www.youtube.com/Dannymusique",
        icon: FaYoutube,
        color: "#ff0000",
      },
      {
        url: "https://api.whatsapp.com/send?phone=212606457519",
        icon: FaWhatsapp,
        color: "#25d366",
      },
    ],
  },
  {
    ...
    social: [
      {
        url: "https://www.facebook.com/edudzi14?_rdc=1&_rdr",
        icon: FaFacebook,
        color: "#1877f2",
      },
      {
        url: "https://www.instagram.com/edudzi14/",
        icon: FaInstagram,
        color: " #bc2a8d",
      },
      {
        url: "https://www.youtube.com/channel/UCe7I6j-eJjM3m1zs-BiwnYA",
        icon: FaYoutube,
        color: "#ff0000",
      },
      {
        url: "https://api.whatsapp.com/send?phone=212609978892",
        icon: FaWhatsapp,
        color: "#25d366",
      },
    ],
